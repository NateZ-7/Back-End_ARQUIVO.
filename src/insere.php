...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $stmt = $pdo->prepare("INSERT INTO produtos (nome, preco, quantidade) VALUES (?, ?, ?)");//Para evitar o sqlinjection, usamos o prepare() para preparar a consulta SQL, e depois o execute() para executar a consulta com os valores fornecidos pelo usuário.
