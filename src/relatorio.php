...
include_once 'header.php';//Carrega o arquivo de cabeçalho, que contém o HTML inicial e a navegação.
?>
...
<!-- //onsubmit é um evento que ocorre quando o formulário é enviado, e a função confirm() exibe uma caixa de diálogo de confirmação, retornando true se o usuário clicar em "OK" e false se clicar em "Cancelar". Isso impede que o formulário seja enviado se o usuário cancelar a ação -->